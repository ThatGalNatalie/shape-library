  ...
  render() {
    ...
    illustrationData.map(function(item) {
      if (item.type.toLowerCase() === category.toLowerCase()) {
        item.animatedIllustrationsCollection.items.filter(function(illustration) {
          try {
            if (
    ...
    if (
      ...
      try {
        ...
        const arr1 = '[' + rgb1.r / 255 + ', ' + rgb1.g / 255 + ', ' + rgb1.b / 255 + ']';

        const hex2 = colourNameToHex(this.props.secondaryColor);
        const rgb2 = hexToRgb(hex2);

        const arr2 = '[' + rgb2.r / 255 + ', ' + rgb2.g / 255 + ', ' + rgb2.b / 255 + ']';
        console.log(2, arr2);
    ...
    if (this.props.primaryColor[0] === '#' || this.props.secondaryColor[0] === '#') {
      function hexToRgb(hex) {
      ...
      const arr1 =
        '[' + primaryHex.r / 255 + ', ' + primaryHex.g / 255 + ', ' + primaryHex.b / 255 + ']';
      const arr2 =
        '[' +
    ...
    const newFormat =
      selected.code1 +
      `${selectedTheme.themePrimaryColor ? selectedTheme.themePrimaryColor : [0, 0, 0, 0]}` +
      selected.code2 +
      `${selectedTheme.themeSecondaryColor ? selectedTheme.themeSecondaryColor : [0, 0, 0, 0]}` +
      selected.code3;
